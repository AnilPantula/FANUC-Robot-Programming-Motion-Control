...
The robot running the full simulated pick-and-place cycle from taught waypoints: approach, pick, lift, transfer, place, retract, and back home.
...
Teaching and recording a new position into the program on the teach pendant, then moving the robot to it to confirm the point.
...
This is where the robot work connects to my PLC and HMI experience: the motion is proven, and the next step is wrapping the cell control around it.

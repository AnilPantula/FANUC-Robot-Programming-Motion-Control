...
### Complete Simulated Pick-and-Place Cycle

<!-- 🎥 link or embed Videos/PickPlaceCycle.mp4 -->
[▶ PickPlaceCycle.mp4](Videos/PickPlaceCycle.mp4)

The robot running the full waypoint sequence start to finish.

### Teach Pendant Walkthrough

<!-- 🎥 link or embed Videos/TeachPendantWalkthrough.mp4 -->
[▶ TeachPendantWalkthrough.mp4](Videos/TeachPendantWalkthrough.mp4)

Me walking through my TP program and explaining how it works.
...
<!-- Six photos, in this order. Drop them into /Images. -->

| ![Hero Robot](Images/robot-full.png) | ![Robot Workcell](Images/workcell.png) | ![Teach Pendant Programming](Images/teach-pendant.png) |
|:---:|:---:|:---:|
| **Hero Robot** | **Robot Workcell** | **Teach Pendant Programming** |

| ![Mastering & Zero Position](Images/mastering-zero.png) | ![Coordinate Systems](Images/coordinate-systems.png) | ![Robot Executing Motion](Images/robot-motion.png) |
|:---:|:---:|:---:|
| **Mastering & Zero Position** | **Coordinate Systems (Tool/User Frames)** | **Robot Executing Motion** |
...
> **This section will be written around my actual TP program once the robot is recorded.** I will add the real program here, the J and L moves I used, where I chose FINE versus CNT, and my actual motion path, and explain the reasoning behind each choice instead of describing FANUC programming in general.
